...
public class LinearRegressionMapper
    extends Mapper<LongWritable, Text, Text, Text> {
	    ...
	    x = x + columns[5];
            context.write(new Text("Noise"), new Text(x + "\t" + Noise));
            context.write(new Text("Homeless"), new Text(x + "\t" + Homeless));
            context.write(new Text("animalAbuse"), new Text(x + "\t" + animalAbuse));
	    context.write(new Text("Safety"), new Text(x + "\t" + Safety));
	    context.write(new Text("drugActivity"), new Text(x + "\t" + drugActivity));
        }
}      
