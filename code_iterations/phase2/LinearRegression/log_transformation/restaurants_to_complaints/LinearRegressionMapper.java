...
public class LinearRegressionMapper
    extends Mapper<LongWritable, Text, Text, Text> {
		...
		x = x + String.valueOf(log_count) + " ";
            ...
            context.write(new Text("Noise"), new Text(x + "\t" + String.valueOf(Math.log(Double.parseDouble(Noise) + 1))));
            context.write(new Text("Homeless"), new Text(x + "\t" + String.valueOf(Math.log(Double.parseDouble(Homeless) + 1))));
            context.write(new Text("animalAbuse"), new Text(x + "\t" + String.valueOf(Math.log(Double.parseDouble(animalAbuse) + 1))));
	    context.write(new Text("Safety"), new Text(x + "\t" + String.valueOf(Math.log(Double.parseDouble(Safety) + 1))));
	    context.write(new Text("drugActivity"), new Text(x + "\t" + String.valueOf(Math.log(Double.parseDouble(drugActivity) + 1))));
        }
}      
